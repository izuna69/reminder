...
| 버전 (Version) | 배포 날짜 | 주요 변경 사항 (Changelog) | 다운로드 | 상태 |
| :---: | :---: | :--- | :---: | :---: |
| **v1.1.0** | 2026.01.16 | • 홈 화면 위젯(`home_widget`) 기능 추가<br>• 다크 모드 테마 적용 | [Link](#) |  Latest |
| **v1.0.2** | 2026.01.10 | • `flutter_local_notifications` 알림 권한 버그 수정<br>• 한국어 날짜 포맷팅 개선 | [Link](#) | Stable |
| **v1.0.1** | 2026.01.05 | • 할 일 체크리스트 UI 개선<br>• 인메모리 데이터 저장 로직 최적화 | [Link](#) | Old |
| **v1.0.0** | 2026.01.01 | • 초기 베타 버전 릴리즈<br>• 기본 할 일 CRUD 기능 구현 | [Link](#) | Deprecated |
